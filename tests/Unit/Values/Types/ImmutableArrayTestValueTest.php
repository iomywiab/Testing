 ...
 * File name: ImmutableArrayTestValueTest.php
 * Project: Testing
...
#[CoversClass(ImmutableArrayTestValueObject::class)]
#[UsesClass(AbstractImmutableTestValueObject::class)]
#[UsesClass(TagEnum::class)]
#[UsesClass(Tags::class)]
class ImmutableArrayTestValueTest extends TestCase
{
    /**
     * @return void
    ...
    {
        $value = new ImmutableArrayTestValueObject('test', ['a' => 1, 'b' => 2]);
        self::assertEquals(['a' => 1, 'b' => 2], $value->toArray());
        self::assertSame('[a=>1,b=>2]', $value->toString());
    }
}
